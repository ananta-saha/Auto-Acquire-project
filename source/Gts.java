...
class Gts extends JFrame implements ActionListener{
    ...
    public Gts() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car13.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Ferrari 812 GTS");
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "<b>Engine:</b> 6.5-liter naturally-aspirated V12<br>" +
                "<b>Horsepower:</b> 800 hp<br>" +
                "<b>Torque:</b> 530 lb-ft<br>" +
                "<b>Transmission:</b> 7-speed dual-clutch<br>" +
                "<b>Acceleration(0-60 mph):</b> 3.0 seconds<br>" +
                "<b>Top Speed:</b> Over 211 mph<br>" +
                "<b>Drivetrain:</b> Rear-wheel drive<br>" +
                "<b>Fuel Economy (city/highway/combined):</b> 15 mpg / 21 mpg / 17 mpg (estimated)<br>" +
