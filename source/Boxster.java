...
class Boxster extends JFrame implements ActionListener{
    ...
    public Boxster() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car1.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Porsche 718 Boxster");
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "• Mid-engine roadster<br>" +
                "• Available in coupe and convertible body styles<br>" +
                "• 2.0-liter or 3.0-liter turbocharged flat-four engine options<br>" +
                "• Horsepower ranging from 300 hp to 420 hp (depending on model)<br>" +
                "• 0-60 mph acceleration in as fast as 3.9 seconds (with certain options)<br>" +
                "• Agile handling and a thrilling driving experience<br>" +
                "•Luxurious and comfortable interior<br>" +
                "•Price : $320,000<br>" +
                "</body></html>");
