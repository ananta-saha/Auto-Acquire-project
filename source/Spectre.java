...
class Spectre extends JFrame implements ActionListener{
    ...
    public Spectre() {
        ...
        // Adding car image 1
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car34.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);



        JLabel textLabel = new JLabel(" The Spectre");
