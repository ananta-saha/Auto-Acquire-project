...
class Mc1 extends JFrame implements ActionListener{
    ...
    public Mc1() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car21.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("McLaren 600LT");
        ...
        String mclarenDetails = "<html><body>" +
                "<b>McLaren 600LT</b><br>" +
                "<b>Engine: placeholder for engine type (e.g., 3.8L Twin-Turbo V8)" + "<br>" +
                "<b>Horsepower: placeholder for horsepower>" + " hp<br>" +
                "<b>Torque: placeholder for torque>" + " lb-ft<br>" +
                "<b>Transmission: placeholder for transmission type (e.g., 7-Speed Dual-Clutch)" + "<br>" +
                "<b>Acceleration (0-60 mph): placeholder for 0-60 mph time> secs<br>" +
                "<b>Top Speed: placeholder for top speed> mph<br>" +
                "<b>Dry Weight: placeholder for dry weight> lbs<br>" +
                "<b>**Aerodynamics:**</b> Focuses on downforce for track performance<br>" +
                "</body></html>";
