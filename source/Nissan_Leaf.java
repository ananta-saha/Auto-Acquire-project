...
class Nissan_Leaf extends JFrame implements ActionListener {
  ...
  public Nissan_Leaf(){
		...
		l1 = new JLabel("Performance: It offers up to 121 MPGe in the city and");
        l1.setFont(new Font("Arial", Font.PLAIN, 15));
        l1.setForeground(Color.black);
        l1.setBounds(300, 245, 400, 30);
        background.add(l1);
		
		l2 = new JLabel("has an EPA-estimated range of up to 212 miles with the SV PLUS model.");
        l2.setFont(new Font("Arial", Font.PLAIN, 15));
        l2.setForeground(Color.black);
        l2.setBounds(300, 270, 500, 30);
        background.add(l2);
		
		l6 = new JLabel("Battery: The vehicle comes with either a 40 kWh or an available");
        l6.setFont(new Font("Arial", Font.PLAIN, 15));
        l6.setForeground(Color.black);
        l6.setBounds(300, 295, 500, 30);
        background.add(l6);
		
		l3 = new JLabel(" 60 kWh battery option.");
        l3.setFont(new Font("Arial", Font.PLAIN, 15));
        l3.setForeground(Color.black);
        l3.setBounds(300, 320, 500, 30);
        background.add(l3);
		
		l4 = new JLabel("Technology: The Nissan Leaf features NissanConnect, which allows for seamless integration");
        l4.setFont(new Font("Arial", Font.PLAIN, 15));
        l4.setForeground(Color.black);
        l4.setBounds(300, 345, 660, 30);
        background.add(l4);
				
		l7 = new JLabel("with your compatible devices, and an 8” touch-screen display.");
        l7.setFont(new Font("Arial", Font.PLAIN, 15));
        l7.setForeground(Color.black);
        l7.setBounds(300, 370, 500, 30);
        background.add(l7);

		l7 = new JLabel("It has been offered exclusively as a 5-door hatchback.");
        l7.setFont(new Font("Arial", Font.PLAIN, 15));
        l7.setForeground(Color.black);
        l7.setBounds(300, 395, 500, 30);
        background.add(l7);
		
		l5 = new JLabel("Price: $29,280");
