...
class Bentayga extends JFrame implements ActionListener{
    ...
    public Bentayga() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car4.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Bentley Bentayga");
        ...
        JLabel textLabel1 = new JLabel("<html><body><br>" +
                ...
                "- Engine: 8.0-liter W12<br>" +
                "- Twin-turbocharged with direct inter-cooling<br>" +
                "- Power Output: 600 bhp @ 6000 rpm<br>" +
                "- Torque: 750 Nm @ 1600 rpm<br>" +
                "- Transmission: 8-speed automatic with block shifting<br>" +
                "- Top Speed: 300 kmph<br>" +
                "- 0-100 kmph: 4.8 seconds<br>" +
                "**Dimensions**<br>" +
                "- Length: 5295 mm<br>" +
