...
class Roadster extends JFrame implements ActionListener{
    ...
    public Roadster() {
        ...
        JPanel backgroundPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon imageIcon = new ImageIcon(getClass().getResource("/ALL IMAGES/bg3.png"));
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car16.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Lamborghini Aventador Roadster");
        textLabel.setFont(new Font("Arial", Font.BOLD, 20));
        textLabel.setForeground(Color.black);
        textLabel.setBounds(430, 260, 380, 30);
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "<b>Engine:</b><br>" +
                "Naturally aspirated or twin-turbocharged V16<br>" +// Replace with actual image URL if desired
                "<b>Horsepower:</b> 800 hp (LP 610-4) to 1100 hp (STO)<br>" +
                "<b>Torque:</b> 412 lb-ft (LP 610-4) to 600 lb-ft (STO)<br>" +
                "<b>Transmission:</b> 7-speed dual-clutch automatic<br>" +
                "<b>Acceleration (0-60 mph):</b> 2.4 seconds to 3.2 seconds (LP 610-4)<br>" +
