...
class Audi_Q8_e_tron extends JFrame implements ActionListener {
  JLabel l1,l2,l3,l4,l5,l6,l7,p;
  JButton backButton,b1;
  JLabel background;
  
  public Audi_Q8_e_tron(){
	    super("Audi_Q8_e_tron");
		...
		l1 = new JLabel("Battery Technology: 114 kwh");
        l1.setFont(new Font("Arial", Font.PLAIN, 15));
        l1.setForeground(Color.black);
        l1.setBounds(300, 245, 400, 30);
        background.add(l1);
		
		l2 = new JLabel("Length: 4915 mm (193.5 inches)");
        l2.setFont(new Font("Arial", Font.PLAIN, 15));
        l2.setForeground(Color.black);
        l2.setBounds(300, 270, 500, 30);
        background.add(l2);
		
		l6 = new JLabel("Width (without mirrors): 1935 mm (76.2 inches)");
