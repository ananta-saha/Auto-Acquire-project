...
class S extends JFrame implements ActionListener{
    ...
    public S() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car29.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Mercedes S-Class");
        ...
        String sClassDetails = "<html><body>" +
                "<b>Mercedes-Benz S-Class</b><br>" +
                "<b>Starting MSRP:placeholder for starting MSRP>" + "<br>" +
                "<b>Engine: Available in various options (refer to website for details)<br>" +  // Placeholder with website suggestion
                "<b>Horsepower: Up to (placeholder for max horsepower) hp<br>" +  // Mention maximum horsepower
                "<b>Transmission: 9-Speed Automatic<br>" +
                "<b>Seating: 5 (standard), 4 (optional with rear passenger seats)<br>" +
                "<b>Fuel Economy (city/highway): (placeholder for city and highway MPG) mpg<br>" +  // Placeholder for MPG
                "<b>Features: Luxurious interior, advanced driver assistance systems<br>" +
                "</body></html>";

        JLabel textLabel1 = new JLabel(sClassDetails);
