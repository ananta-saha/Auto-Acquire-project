...
public class AdminAdd extends JFrame {
    ...
    AdminAdd() {
        ...
        label1.setBounds(245, 75, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf1 = new JTextField();
        tf1.setBounds(385, 85, 260, 30);
        tf1.setFont(f5);
        c.add(tf1);
        ...
        label1.setBounds(245, 110, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf2 = new JTextField();
        tf2.setBounds(385, 120, 260, 30);
        tf2.setFont(f5);
        c.add(tf2);
        ...
        label1.setBounds(245, 145, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf3 = new JPasswordField();
        tf3.setBounds(385, 155, 260, 30);
        tf3.setFont(f2);
        tf3.setEchoChar('*');
        c.add(tf3);
