...
class Cayenee extends JFrame implements ActionListener{
    ...
    public Cayenee() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car11.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Porsche Cayenne");
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "• Luxury SUV with exceptional performance<br>" +
                "• Powerful engine options, typically ranging from 335 hp to over 600 hp<br>" +
                "• Spacious and comfortable interior with seating for five<br>" +
                "• Excellent handling and on-road dynamics for an SUV<br>" +
                "• Available in various trim levels offering increasing performance and features<br>" +
                "• Versatile option for families or those who need cargo space and luxury<br>" +
                "• Blends practicality of an SUV with Porsche's renowned driving experience<br>" +
                "• Price: $290,000<br>" +
                "</body></html>");

        textLabel1.setFont(new Font("Arial", Font.BOLD, 18)); // Adjusted font size to 18 as specified
        textLabel1.setForeground(Color.white);
        textLabel1.setBounds(200, 310, 400, 350);
