...
class Gla extends JFrame implements ActionListener{
    ...
    public Gla() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car28.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Mercedes GLA-Class");
        ...
        String glaDetails = "<html><body>" +
                "<b>Mercedes-Benz GLA-Class</b><br>" +
                "<b>Starting MSRP:placeholder for starting MSRP>" + "<br>" +
                "<b>Seating: Up to 5<br>" +
                "<b>Engine Options:placeholder for engine options (e.g., 2.0L turbocharged I4)>" + "<br>" +
                "<b>Transmission:placeholder for transmission type (e.g., 8-Speed Automatic)" + "<br>" +
                "<b>Fuel Economy (est. city/highway): placeholder for city and highway MPG>" + "<br>" +
                "<b>Drivetrain:placeholder for drivetrain" + "<br>" +
                "<b>Luxurious & Spacious Interior<br>" +
                "</body></html>";

        JLabel textLabel1 = new JLabel(glaDetails);
