...
class Mc3 extends JFrame implements ActionListener{
    ...
    public Mc3() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car24.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("McLaren 675LT");
        ...
        String mclarenDetails = "<html><body>" +
                "<b>McLaren 675LT</b><br>" +
                "Engine: 3.8L Twin-Turbocharged V8<br>" +
                "Horsepower: 666 hp<br>" +
                "Torque: 516 lb-ft<br>" +
                "Transmission: 7-Speed SSG Dual-Clutch<br>" +
                "Acceleration (0-60 mph): 2.9 seconds<br>" +
                "Top Speed: 205 mph<br>" +
                "Curb Weight: 2,775 lbs<br>" +
                "Fuel Economy (combined): 15 mpg<br>" +
                "</body></html>";
