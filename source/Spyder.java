...
class Spyder extends JFrame implements ActionListener{
    ...
    public Spyder() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car18.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Lamborghini Huracán Spyder");
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "<b>Engine:</b><br>" +
                "Naturally aspirated or twin-turbocharged V12 <br>" +// Replace with actual image URL if desired
                "<b>Horsepower:</b> 700 hp (LP 610-4) to 900 hp<br>" +
                "<b>Torque:</b> 500 lb-ft (LP 610-4) to 650 lb-ft<br>" +
                "<b>Transmission:</b> 8-speed dual-clutch automatic<br>" +
                "<b>Acceleration (0-60 mph):</b> 2.5 seconds to 3.2 seconds (LP 610-4)<br>" +
                "<b>Top Speed:</b> 202 mph (LP 610-4) to 250 mph<br>" +
        ...
        textLabel1.setBounds(200, 270, 400, 350);
