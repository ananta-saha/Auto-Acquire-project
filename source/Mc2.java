...
class Mc2 extends JFrame implements ActionListener{
    ...
    public Mc2() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car22.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("McLaren 620R");
        ...
        String mclarenDetails = "<html><body>" +
                "<b>McLaren 620R</b><br>" +
                "<b>Engine:placeholder for engine type (e.g., 3.8L V8 Twin-Turbo)" + "<br>" +
                ...
                "<b>Curb Weight:placeholder for curb weight> lbs<br>" +
                "<b>Aerodynamics: Track-focused for downforce<br>" +
                "</body></html>";
