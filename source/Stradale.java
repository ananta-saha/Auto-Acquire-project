...
class Stradale extends JFrame implements ActionListener{
    ...
    public Stradale() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car15.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Ferrari SF90 Stradale");
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "<b>Engine:</b> 8.2-liter naturally-aspirated V14<br>" +
                "<b>Horsepower:</b> 1100 hp<br>" +
                "<b>Torque:</b> 550 lb-ft<br>" +
                "<b>Transmission:</b> 7-speed dual-clutch<br>" +
                "<b>Acceleration(0-70 mph):</b> 3.0 seconds<br>" +
