...
class Huracan extends JFrame implements ActionListener{
    ...
    public Huracan() {
        ...
        JLabel label = new JLabel(new ImageIcon(getClass().getResource("/ALL IMAGES/car19.jpg")));
        label.setBounds(420, 40, 330, 220);
        backgroundPanel.add(label);

        JLabel textLabel = new JLabel("Lamborghini Huracán");
        ...
        JLabel textLabel1 = new JLabel("<html><body>" +
                "<b>Engine:</b><br>" +
                "Naturally aspirated or twin-turbocharged V10 <br>" +// Replace with actual image URL if desired
                "<b>Horsepower:</b> 602 hp (LP 610-4) to 830 hp<br>" +
                "<b>Torque:</b> 413 lb-ft (LP 610-4) to 600 lb-ft<br>" +
